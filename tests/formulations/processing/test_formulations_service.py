...
def _create_expected_df_as_dict():
    return {
        ...
        'Aggregates (kg)': {0: '780.0', 1: '770.0', 2: '680.0', 3: '670.0', 4: '780.0', 5: '770.0', 6: '680.0',
                            7: '670.0'},
        ...
        'gravity': {0: 10.0, 1: 10.0, 2: 10.0, 3: 10.0, 4: 2.0, 5: 2.0, 6: 2.0, 7: 2.0},
        'na2_si_o3': {0: 20.0, 1: 20.0, 2: 20.0, 3: 20.0, 4: 20.0, 5: 20.0, 6: 20.0, 7: 20.0},
        'na_o_h': {0: 4.1, 1: 4.1, 2: 4.1, 3: 4.1, 4: 4.1, 5: 4.1, 6: 4.1, 7: 4.1},
        'na2_si_o3_specific': {0: 4.0, 1: 4.0, 2: 4.0, 3: 4.0, 4: 4.0, 5: 4.0, 6: 4.0, 7: 4.0},
        'water': {0: 11.0, 1: 11.0, 2: 11.0, 3: 11.0, 4: 11.0, 5: 11.0, 6: 11.0, 7: 11.0},
        ...
        'fa_density': {0: 6.0, 1: 6.0, 2: 6.0, 3: 6.0, 4: 6.0, 5: 6.0, 6: 6.0, 7: 6.0},
        'ca_density': {0: 16.0, 1: 16.0, 2: 16.0, 3: 16.0, 4: 16.0, 5: 16.0, 6: 16.0, 7: 16.0},
