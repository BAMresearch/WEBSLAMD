...
function handleSubmittingLiquidCosts(event){
    ...
    const liquid = { 'material_type':'Liquid', 'material_name' : liquid_name,  "co2_footprint" : liquid_cost_CO_2, "costs" : liquid_cost_EUR, "delivery_time" : liquid_cost_delivery_time }
