...
class LiquidStrategy(MaterialStrategy):
    ...
    def create_material_from_dict(cls, dictionary):
        ...
        if "specific_gravity" not in dictionary:
            dictionary["specific_gravity"] = LIQUID_DEFAULT_SPECIFIC_GRAVITY
    ...
    def create_model(cls, submitted_material):
        ...
        return Liquid(
            ...
            specific_gravity=submitted_material.get('specific_gravity', LIQUID_DEFAULT_SPECIFIC_GRAVITY),
    ...
    def create_blended_material(cls, name, normalized_ratios, base_liquid_as_dict):
        specific_gravity = cls.compute_blended_specific_gravity(normalized_ratios, base_liquid_as_dict)
