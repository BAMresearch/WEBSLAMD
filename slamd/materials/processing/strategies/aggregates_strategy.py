...
class AggregatesStrategy(MaterialStrategy):
    ...
    def create_material_from_dict(cls, dictionary):
        ...
        if "specific_gravity" not in dictionary:
            dictionary["specific_gravity"] = AGGREGATE_DEFAULT_SPECIFIC_GRAVITY
    ...
    def create_model(cls, submitted_material):
        ...
        return Aggregates(
            ...
            specific_gravity=submitted_material.get('specific_gravity', AGGREGATE_DEFAULT_SPECIFIC_GRAVITY),
