...
class AggregatesStrategy(MaterialStrategy):
    ...
    @classmethod
    def create_blended_material(cls, ratios_for_naming, blended_material_name, normalized_ratios, base_aggregates_as_dict):
        ...
        return Aggregates(type=base_aggregates_as_dict[0]['type'],
                          name=f'{blended_material_name}-{ratios_for_naming}',
                          costs=costs,
                          composition=composition,
