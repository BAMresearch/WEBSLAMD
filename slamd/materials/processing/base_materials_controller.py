...
def base_material_page():
    ...
    return render_template(
        'base_materials.html', form=form, materials_response=materials_response
    )
...
def add_additional_property():
    ...
    form = BaseMaterialService.create_additional_property_form(
...
def delete_base_material(material_type, uuid):
    ...
    body = {
        'template': render_template(
            'materials_table.html', materials_response=materials_response
        )
    }
    return make_response(jsonify(body), 200)
